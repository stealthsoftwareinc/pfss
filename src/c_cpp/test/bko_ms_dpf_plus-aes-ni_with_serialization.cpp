...
#include <pfss/ms_dpf_plus_test_helper.h>
...
int main() {
  try {
    ...
    using scheme_type = bko_ms_dpf_plus_v<two_party_ms_dpf_plus_type>;
    typename scheme_type::rng_type r;
    bool const pass =
        ms_dpf_plus_test_correctness_with_serialization<scheme_type>(
            r,
            1001,
            10,
            126);
