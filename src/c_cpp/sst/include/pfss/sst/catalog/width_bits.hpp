...
#ifndef PFSS_SST_CATALOG_WIDTH_BITS_HPP
#define PFSS_SST_CATALOG_WIDTH_BITS_HPP
...
struct width_bits<
    ...
    : std::integral_constant<int,
                             ::pfss::sst::value_bits<IntType>::value
                                 + static_cast<int>(
...
#endif // #ifndef PFSS_SST_CATALOG_WIDTH_BITS_HPP
