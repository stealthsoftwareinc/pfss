...
#ifndef PFSS_SST_CATALOG_IS_UNSIGNED_INTEGER_HPP
#define PFSS_SST_CATALOG_IS_UNSIGNED_INTEGER_HPP
...
PFSS_SST_DEFINE_BOOLEAN_TRAIT_1(
    ...
    (::pfss::sst::is_integer<T>::value
     && std::is_unsigned<::pfss::sst::remove_cvref_t<T>>::value))

}} // namespace pfss::sst

#endif // #ifndef PFSS_SST_CATALOG_IS_UNSIGNED_INTEGER_HPP
