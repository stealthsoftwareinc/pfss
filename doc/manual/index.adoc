...
PFSS also currently requires CPU or library support for certain
...
If you have none of these, then `make` will fail.

You can then build and install PFSS with the following commands:
